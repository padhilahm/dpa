						...
						<div class="col-md-12">
							<div class="card shadow">
								...
								<?php if ($this->session->flashdata('success')) : ?>
									...
									<div class="card-body">
										<form action="<?= base_url('satuan/proses_ubah/' . $satuan->id_satuan) ?>" id="form-tambah" method="POST">
											<div class="form-row">
												
												<div class="form-group col-md-12">
													<label for="nama"><strong>Nama Satuan</strong></label>
													<input type="text" name="nama" placeholder="Masukkan nama satuan. . ." autocomplete="off"  class="form-control" required value="<?= $satuan->satuan ?>">
												</div>
											</div>
