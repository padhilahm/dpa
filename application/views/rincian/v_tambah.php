                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('rincian/proses_tambah') ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="number" name="koefisien" id="koefisien" autocomplete="off" class="form-control" required>
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="harga"><strong>Harga</strong></label>
                                                <input type="text" name="harga" id="harga" autocomplete="off" class="form-control" required>
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="ppn"><strong>PPN</strong></label>
                                                <input type="text" name="ppn" id="ppn" autocomplete="off" class="form-control" required>
                                            </div>
