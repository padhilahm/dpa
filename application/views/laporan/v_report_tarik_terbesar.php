    ...
    <page size='A4'>
        <div class="container-fluid">
            ...
            <div class="col text-center">
                <h3 class="h3 text-dark">Rencana Penarikan Dana Terbesar Pertahun</h3>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <?php foreach ($tarik_terbesar as $tarik) : ?>
                <tr>
                    <td><?php echo rupiah($tarik->total); ?></td>
                    <td><?php echo $tarik->tahun; ?></td>
                </tr>
                <?php endforeach ?>
            </table>
            <hr>
